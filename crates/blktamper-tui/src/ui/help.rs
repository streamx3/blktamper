...
const KEYS: &[(&str, &str)] = &[
    ...
    ("S", "describe overwriting deleted records here"),
    ("  c", "compact: remove them, close the gap, zero the tail"),
    ("  s", "sweep: blank every tombstone, zero the tail"),
    ("  n / z", "one record: keep its marker / zero it outright"),
